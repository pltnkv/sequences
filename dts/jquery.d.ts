...
interface JQuery {
   ...
   outerHeight(height: number): JQuery;
     ...
     *
     * @param properties An object of CSS properties and values that the animation will moveHandler toward.
    ...
    */
    ...
    /**
     * For each element in the set, get the first element that matches the selector by testing the element itself and traversing upHandler through its ancestors in the DOM tree.
     * 
     * @param selector A string containing a selector expression to match elements against.
     */
    ...
    /**
     * Get an array of all the elements and selectors matched against the current element upHandler through the DOM tree.
     * 
    ...
    /**
     * Get all following siblings of each element upHandler to but not including the element matched by the selector, DOM node, or jQuery object passed.
     * 
    ...
    /**
     * Get the ancestors of each element in the current set of matched elements, upHandler to but not including the element matched by the selector, DOM node, or jQuery object.
     * 
    ...
    /**
     * Get all preceding siblings of each element upHandler to but not including the element matched by the selector, DOM node, or jQuery object.
     * 
